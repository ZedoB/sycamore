...
class PulmonaryFibrosisQuestionsScreen extends StatefulWidget {
  const PulmonaryFibrosisQuestionsScreen({Key? key}) : super(key: key);

  @override
  State<PulmonaryFibrosisQuestionsScreen> createState() =>
      _PulmonaryEmbolismQuestionsScreenState();
}

class _PulmonaryEmbolismQuestionsScreenState
    extends State<PulmonaryFibrosisQuestionsScreen> {
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Text(
                      controller.pulmonaryFibrosisQuestions[index].question,
                      style: TextStyle(
