...
class InterstitialLungDiseaseQuestionsScreen extends StatefulWidget {
  const InterstitialLungDiseaseQuestionsScreen({Key? key}) : super(key: key);

  @override
  State<InterstitialLungDiseaseQuestionsScreen> createState() =>
      _PulmonaryEmbolismQuestionsScreenState();
}

class _PulmonaryEmbolismQuestionsScreenState
    extends State<InterstitialLungDiseaseQuestionsScreen> {
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child: Text(
                      controller.interstitialLungDiseaseQuestions[index].question,
                      style: TextStyle(
